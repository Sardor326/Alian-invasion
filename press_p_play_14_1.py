...
moves up and down at a steady rate. Then on the left side of the screen, create a ship that the player can move up and down while firing bullets at the 
...
from settings_target import Settings
from game_stats import GameStats
from button_target import Button
from ship_target import Ship
from bullet_target import Bullet
